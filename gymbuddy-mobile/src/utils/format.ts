...
/** Session display title from date (detail): "FRI July 24, 2026" */
export const formatSessionTitle = (d: string): string => formatFullDate(d)

/** Compact list-column title: "7/24" */
export const formatSessionListTitle = (d: string): string => formatMonthDay(d)
